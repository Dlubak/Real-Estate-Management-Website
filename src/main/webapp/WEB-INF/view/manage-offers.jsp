  ...
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col">Miniature</th>
		...
		<tbody>
    <tr>
      <th scope="row">${tempOffer.title}</th>
      ...
      <td>${tempOffer.price}</td>
			...
			<td><a href="/admin/offer/update/${tempOffer.id}/">Update</a> </td>
	 		<td><a href="/admin/offer/delete/${tempOffer.id}" onclick="if (!(confirm('Are you sure you want to delete this offer?'))) return false">Delete</a></td>
    </tr>
		</tbody>
		</c:forEach>
</table>
