  ...
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col">Email</th>
			...
			<th scope="col">Manage Offers</th>
    </tr>
  </thead>
		<c:forEach var="user" items="${userList}">
		<tbody>
    <tr>
      <th scope="row"><a href="/admin/edit/${user.id}"><c:out value="${user.firstName}" /></th>
      ...
      <td><c:out value="${user.email}" /></td>
			...
			<td><a href="/admin/offers/${user.id}">Offers</td>
    </tr>
		</tbody>
		</c:forEach>
</table>
